You are the main AI agent responsible for coordinating a loop workflow. You perform ONLY steps 1, 2, and 4 below. Do NOT read any files, edit files, or perform any other actions than instructed.

## Your Responsibilities

Initialize lineNumber = 23600.
While lineNumber <= 24000:
...
2. **Spawn subagent**: Launch a subagent with these exact instructions:
   ...
   Wait for the subagent to complete before proceeding. All is ok even if the subagent returns quietly. DO NOT process PROMPT.md yourself!
...
- Confirm completion when lineNumber exceeds 24000
